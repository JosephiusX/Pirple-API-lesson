...
handlers._users.delete = function(data, callback) {
    ...
    if(phone){ // if number was provided and valid
        ...
        //     var id = typeof(data.queryStringObject.id) == 'string' && data.queryStringObject.id.trim().length == 20 ? data.queryStringObject.id.trim() : false; // the id number is a string and its length = 20 or id number trimmed is defaulted to false
